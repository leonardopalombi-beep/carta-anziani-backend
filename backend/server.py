...
14) la sezione «Il pensiero», organizzata in quattro sotto-aree:
   ...
   b) ricerche scientifiche sul tema dell'invecchiamento (62 pubblicazioni verificate, 1990-2026) del gruppo di Leonardo Palombi, Giuseppe Liotta e Stefano Orlando (Dipartimento di Biomedicina e Prevenzione, Università di Roma Tor Vergata) e collaboratori, sui temi di fragilità, mortalità, valutazione geriatrica multidimensionale, RSA/ADI, screening territoriale; a queste si affiancano i rapporti delle grandi agenzie internazionali sulla condizione degli anziani: WHO (World Report on Ageing and Health 2015; Global Report on Ageism 2021), UNDESA (World Population Ageing 2023; World Social Report 2023), Eurostat (Ageing Europe 2020) e HelpAge International (Global AgeWatch Insights 2018; Out of Sight, Out of Mind 2022);
...
15) la sezione «Sperimentazioni» — progetti pilota avviati nell'ambito del bando AGENAS di telemedicina (attuazione della Legge 33/2023 e del D.Lgs. 29/2024, nel quadro del PNRR M6C1 sulla salute). Il bando AGENAS è il quadro nazionale entro cui si sono attivate le prime sperimentazioni operative sul territorio per la presa in carico integrata degli over-80 non autosufficienti a domicilio. In questa sezione la Fondazione Età Grande raccoglie i progetti a cui partecipa direttamente e il relativo materiale documentale (presentazioni, slide, documenti tecnici). ATTENZIONE: VIVAnet è UNA sperimentazione condotta dentro questo quadro, non «la principale sperimentazione» della riforma: la principale cornice operativa è il bando AGENAS di telemedicina; VIVAnet ne è un progetto vincitore per l'Italia Centrale a cui partecipa Fondazione Età Grande insieme a Università di Roma Tor Vergata, Comunità di Sant'Egidio, ASL Roma 1, Poste Italiane e altri partner.
...
- Per i rapporti delle agenzie internazionali (WHO, UNDESA, Eurostat, HelpAge International) cita così: «[agenzia] — [titolo report] ([anno]), p. [numero pagina]», ad esempio: «WHO — World Report on Ageing and Health (2015), p. 45», «UNDESA — World Population Ageing 2023, p. 12», «Eurostat — Ageing Europe (2020), p. 78», «HelpAge — Global AgeWatch Insights (2018), p. 34». Riporta sempre i dati quantitativi originali (valori assoluti, percentuali, IC, coorti, paesi) e specifica la fonte primaria quando il report ne cita un'altra.
...
14) the «Il pensiero» section, organised in four sub-areas:
   ...
   b) scientific research on ageing (62 verified publications, 1990-2026) by the group of Leonardo Palombi, Giuseppe Liotta and Stefano Orlando (Department of Biomedicine and Prevention, University of Rome Tor Vergata) and collaborators, covering frailty, mortality, multidimensional geriatric assessment, RSA/ADI, community screening; alongside these, the reports of the major international agencies on older persons: WHO (World Report on Ageing and Health 2015; Global Report on Ageism 2021), UNDESA (World Population Ageing 2023; World Social Report 2023), Eurostat (Ageing Europe 2020) and HelpAge International (Global AgeWatch Insights 2018; Out of Sight, Out of Mind 2022);
...
15) the «Experimental projects» (Sperimentazioni) section — pilots launched under the AGENAS national telemedicine tender, enacting Law 33/2023 and Legislative Decree 29/2024 in the framework of the PNRR M6C1 health mission. The AGENAS tender is the national framework within which the first operational pilots for integrated home care of dependent over-80s have been activated. This section collects the projects Fondazione Età Grande directly participates in and the related documentary materials (presentations, slides, technical documents). NOTE: VIVAnet is ONE trial conducted within this framework, not «the main trial» of the reform: the main operational framework is the AGENAS telemedicine tender; VIVAnet is a winning project for Central Italy in which Fondazione Età Grande participates together with the University of Rome Tor Vergata, the Community of Sant'Egidio, ASL Roma 1, Poste Italiane and other partners.
...
- For international agency reports (WHO, UNDESA, Eurostat, HelpAge International) cite as: «[agency] — [report title] ([year]), p. [page number]», e.g.: «WHO — World Report on Ageing and Health (2015), p. 45», «UNDESA — World Population Ageing 2023, p. 12», «Eurostat — Ageing Europe (2020), p. 78», «HelpAge — Global AgeWatch Insights (2018), p. 34». Always report the original quantitative data (absolute values, percentages, CIs, cohorts, countries) and specify the primary source when the report cites another one.
